...
import { LayoutDashboard, CalendarDays, Building2, Users, Briefcase, Map, CheckSquare, StickyNote, BarChart3, Settings, Search, Droplets, Activity as ActivityIcon } from 'lucide-react';
